...
router.get('/:userId/history', authMiddleware, balanceController.getTransactionHistory);

router.get('/:userId/deposits', authMiddleware, balanceController.getDeposits);

router.get('/:userId/withdrawals', authMiddleware, balanceController.getWithdrawals);
